...
* [ ] Add `next/font` for Inter + Mono fonts
* [ ] Configure global layout + dark mode base
* [ ] Add `next-seo` or metadata config
* [ ] Create pages: `/`, `/about`, `/projects`
...
* [ ] Define folder structure:
  ...
  styles/
  ```
* [ ] Create nav + footer components
* [ ] Add responsive layout + basic design
