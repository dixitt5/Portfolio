...
contract SimpleStorage {
    ...
    function createUploadRequestbyUser(bool ad, string memory hash) public {
        ...
        wallets[msg.sender].uploadreq[msg.sender].timestamp = block.timestamp;
    }
    ...
    function createUploadRequestbyInstitute(
        ...
        wallets[a].uploadreq[a].timestamp = block.timestamp;
    ...
    function getInstitutesWallet(
        address ad
    ) public view returns (address[] memory) {
        return iminwall[ad];
    }

    function getInstitutesUploadList(
        address ad
    ) public view returns (address[] memory) {
        return wallets[ad].listofuploadreq;
    }
    ...
    function changeOwnerInstfromInst(address stud, address Inst) public {
        ...
        wallets[stud].changeowneri[msg.sender].timestamp = block.timestamp;
    ...
    function changeOwnerInstfromStud(address Inst) public {
        ...
        wallets[msg.sender].changeowneri[msg.sender].timestamp = block
            .timestamp;
    }

    function getChangeOwnerList(
        address a
    ) public view returns (address[] memory) {
    ...
    function getPartialOwnerShipList(
        address a
    ) public view returns (address[] memory) {
    ...
    //         wallets[msg.sender].owners.partialowner[msg.sender].expiry=block.timestamp+ wallets[msg.sender].owners.partialowner[msg.sender].day * 1 minutes;
    ...
    //     wallets[stud].owners.partialowner[reqq].expiry=block.timestamp+ yuyu *1 minutes;
    ...
    //         if(wallets[a].owners.partialowner[msg.sender].day<block.timestamp)
    //          {
    ...
    function getPartialOwnerShipINFO(
        address stud,
        address paro
    ...
    function getUploadRequestTIMESTAMP(
        address stud,
        address reqq
    ...
    function getChangeOwnerRequestTIMESTAMP(
        address stud,
        address reqq
    ) public view returns (uint) {
